 ...
 */
public class PrivateScholarship extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            String url = "https://www.collegedekho.com/private-scholarships-csp-2";
            ...
            out.println("<h1>Private Scholarships</h1>");

            if (!elements.isEmpty()) {
                out.println("<ul>");
                for (Element element : elements) {
                    String scholarshipName = element.select("h3").text(); // Assuming `h3` contains the scholarship title
